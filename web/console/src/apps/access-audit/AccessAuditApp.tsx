...
const PERMISSION_WARNINGS: Record<string, string> = {
  ...
  "cluster.terminal.exec": "可启动携带当前角色 Kubernetes 权限的集群终端",
  ...
  "cluster.node.manage": "可改写节点的标签、污点与调度状态，影响整个集群的调度结果",
