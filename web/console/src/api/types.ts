...
export type MetricsExploreRequest = Schemas["MetricsExploreRequest"];
export type MetricsExploreResult = Schemas["MetricsExploreResult"];
export type MetricsExploreOutcome = MetricsExploreResult["queries"][number];
export type MetricsExploreError = NonNullable<MetricsExploreOutcome["error"]>;
export type MetricsSavedQuery = Schemas["MetricsSavedQuery"];
export type MetricsSavedQueryVisibility = MetricsSavedQuery["visibility"];
export type MetricsSavedQueryRequest = Schemas["MetricsSavedQueryRequest"];
export type CustomApplication = Schemas["CustomApplication"];
export type CustomApplicationRequest = Schemas["CustomApplicationRequest"];
