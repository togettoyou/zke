...
Agent ConfigMap、ServiceAccount、最小 Role/RoleBinding、Node 只读及 Namespace 管理
...
该默认 ClusterRole 满足 Node 类型化只读接口与 Namespace List/Detail/Create/Delete。Agent 的通用
